...
4. **Instrução viva, não changelog.** Docs de start-up (`CLAUDE.md`, `README.md`) carregam toda sessão. Sem histórico, sem status volátil. Teste cada linha: "cortar isso faria o agente errar?" Não → cortar.
