...
O quarto é mensagem pra uma pessoa num canal, e nenhum dos três anteriores descreve ela.
Vale a frase conectada do texto longo, mas o fecho que pede ação pode repetir o pedido,
porque adesão ganha de economia quando alguém tem que fazer algo depois de ler.
